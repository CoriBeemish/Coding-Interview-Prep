...
---
## If you don't feel you aren't smart enough
...
- [ ] [Software Engineer Interview Unleashed (Udemy)](https://www.udemy.com/software-engineer-interview-unleashed)
...
- Pick a topic from below and watch a video on it.
- Make flashcards about that topic.
- Implement the algorithms and data structures on that topic.
- Move on to the next topic.
- Review the flash cards.
- After a few days, watch another video about the previous topic.
- (Read through the material first. Then read it again with understanding. Read it a third time to implement the material.)
...
## Video Series
<details>
<summary>Sit back and enjoy. "Netflix and skill."</summary>
